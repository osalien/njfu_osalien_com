...
- 删除security目录	
- [修改sys_user表结构](https://github.com/osalien/njfu_osalien_com/blob/master/docs/db/mysql_spring_boot_plus.sql)
...
### 📔  Documentation
- [CentOS Quick Installation Environment / Build / Deploy / Launch Spring-boot-plus Project](https://github.com/osalien/njfu_osalien_com#centos-quick-installation-environment--build--deploy--launch-spring-boot-plus-project)
...
- [5 Minutes Finish CRUD](https://github.com/osalien/njfu_osalien_com#5-minutes-finish-crud)
...
- GITHUB：[https://github.com/osalien/njfu_osalien_com](https://github.com/osalien/njfu_osalien_com "spring-boot-plus github")
