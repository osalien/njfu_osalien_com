...
public class PrintApplicationInfo {
    ...
    public static void printTip(ConfigurableApplicationContext context) {
        ...
        tip.append(" 6.FAQ：https://osalien.com\n");
        tip.append(" 7.如开发中遇到bug及问题，欢迎提交ISSUES：https://github.com/osalien/njfu-osalien-com/issues\n");
        tip.append(" 8.公众号：Coding实验室，欢迎关注\n");
        tip.append("                                                                                  \n");
        tip.append("===========================================================================================\n");
    ...
    public static void print(ConfigurableApplicationContext context) {
        ...
        // 项目IP或域名地址
        String serverIp = environment.getProperty("njfu-osalien-com.server-ip");
        // 项目端口
        String port = environment.getProperty("server.port");
        // Spring Boot Admin Server地址，请先在admin模块中启动 CodingLabAdminApplication
        ...
        log.info("njfu-osalien-com project start success...........");
        if ("dev".equals(profileActive)) {
