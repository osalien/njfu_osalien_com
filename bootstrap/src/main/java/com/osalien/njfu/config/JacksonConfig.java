...
import com.osalien.njfu.framework.config.jackson.serializer.JacksonIntegerDeserializer;
import com.osalien.njfu.framework.core.xss.XssJacksonDeserializer;
import com.osalien.njfu.framework.core.xss.XssJacksonSerializer;
...
public class JacksonConfig implements WebMvcConfigurer {
    ...
    @Value("${njfu-osalien-com.filter.xss.enable}")
