...
import com.osalien.njfu.framework.shiro.jwt.JwtFilter;
import com.osalien.njfu.framework.shiro.jwt.JwtRealm;
...
@ConditionalOnProperty(value = {"njfu-osalien-com.shiro.enable"}, matchIfMissing = true)
