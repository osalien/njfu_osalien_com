...
package com.osalien.njfu.aop;

import com.osalien.njfu.framework.log.aop.BaseLogAop;
...
@Aspect
@Component
@ConditionalOnProperty(value = {"njfu-osalien-com.aop.log.enable"}, matchIfMissing = true)
public class LogAop extends BaseLogAop {
    ...
    private static final String POINTCUT =
            "execution(public * com.osalien.njfu..*.controller..*.*(..)) || " +
