...
import com.osalien.njfu.framework.util.UUIDUtil;
import com.osalien.njfu.framework.util.VerificationCode;
...
@ConditionalOnProperty(value = {"njfu-osalien-com.enable-verify-code"}, matchIfMissing = true)
